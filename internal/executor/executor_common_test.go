...
func TestExecutors_CommonBehavior(t *testing.T) {
	...
	testCases := []struct {
		name        string
		getExecutor func() interface {
			Execute(string, []string, ExecOptions) (*ExecResult, error)
		}
	}{
		{
...
func testTimeoutBehavior(t *testing.T, executor interface {
	Execute(string, []string, ExecOptions) (*ExecResult, error)
}) {
	tests := []struct {
		name          string
...
func testErrorHandling(t *testing.T, executor interface {
	Execute(string, []string, ExecOptions) (*ExecResult, error)
}) {
	tests := []struct {
		name           string
...
func testEnvironmentVariables(t *testing.T, executor interface {
	Execute(string, []string, ExecOptions) (*ExecResult, error)
}) {
	tests := []struct {
		name           string
